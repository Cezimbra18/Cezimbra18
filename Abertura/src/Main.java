...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage resultImage1 = erodeImage(grayimage, getStructElements());
        BufferedImage resultImage2 = dilateImage(resultImage1, getStructElements());
        showImage(resultImage2, "Final image ");
    }
